...
public class VehiclePersistenceRequest {
   ...
   public VehiclePersistenceRequest() {
    ...
    public boolean equals(Object o) {
        ...
        final Object this$makeId = this.makeId;
        final Object other$makeId = other.makeId;
        if (this$makeId == null ? other$makeId != null : !this$makeId.equals(other$makeId)) return false;
    ...
    public int hashCode() {
        ...
        final Object $makeId = this.makeId;
        result = result * PRIME + ($makeId == null ? 0 : $makeId.hashCode());
    ...
    public String toString() {
        return "com.thinkful.contract.dto.VehiclePersistenceRequest(id=" + this.id + ", makeId=" + this.makeId + ", modelId=" + this.modelId + ", color=" + this.color + ")";
    }
}
